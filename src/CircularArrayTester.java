public class CircularArrayTester{
  public static void main(String [] args){
    ...
    CircularArray c9 = new CircularArray(linear9, 2, 6);
    CircularArray c10 = new CircularArray(linear9, 5, 6);
    c9.printForward();   // This Should Print: 10, 20, -30, 20, 50, 30.
    c10.printForward();   // This Should Print: 10, 20, -30, 20, 50, 30.
    System.out.println(c9.equivalent(c10));  // This Should Print: true
    
    System.out.println("\n///// TEST 12 /////");
    Object [] linear10 = {10, 20, -30, 20, 50, 30, null, null, null};
    CircularArray c11 = new CircularArray(linear10, 8, 6);
    c10.printForward();   // This Should Print: 10, 20, -30, 20, 50, 30.
